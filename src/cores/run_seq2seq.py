...
# BertForPreTrainingLossMask -> BertForPreTraining
from pytorch_pretrained_bert.modeling import BertForPreTraining
# warmup_linear -> WarmupLinearSchedule
from pytorch_pretrained_bert.optimization import BertAdam, WarmupLinearSchedule

from src.libs.data_parallel import DataParallelImbalance
import src.cores.seq2seq_loader as seq2seq_loader
        ...
        for i_epoch in trange(start_epoch, int(args.num_train_epochs) + 1, desc="Epoch",
            ...
            for step, batch in enumerate(iter_bar):
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    lr_this_step = args.learning_rate * WarmupLinearSchedule(global_step / t_total,
