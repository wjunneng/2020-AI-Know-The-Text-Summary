...
from src_pytorch.libs.util_files import CONFIG_NAME, cached_path, hf_bucket_url, is_remote_url
...
class PretrainedConfig(object):
    ...
    def __init__(self, **kwargs):
        ...
        try:
            ...
            self.id2label = kwargs.pop("id2label", {i: "LABEL_{}".format(i) for i in self.num_labels})
